...
func (m *MockimportService) Configure(arg0 context.Context, arg1, arg2 string, arg3 map[string]model.AccountKind) (model.ImportPreview, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Configure", arg0, arg1, arg2, arg3)
...
func (mr *MockimportServiceMockRecorder) Configure(arg0, arg1, arg2, arg3 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Configure", reflect.TypeOf((*MockimportService)(nil).Configure), arg0, arg1, arg2, arg3)
}
